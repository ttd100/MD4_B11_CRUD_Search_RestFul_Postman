...
public class StudentController {
    ...
    public ResponseEntity<?> createStudent(@RequestBody Student student) {
        ...
        if (studentService.existsByName(student.getName())) {
            return new ResponseEntity<>(new ResponseMessage("The name id existed"), HttpStatus.OK);
        }
        studentService.save(student);
        return new ResponseEntity<>(new ResponseMessage("Created success!"),HttpStatus.OK);
    }
    @GetMapping ResponseEntity<?> showListStudent(){
    ...
    public ResponseEntity<?> deleteStudent(@PathVariable Long id){
        ...
        return new ResponseEntity<>(new ResponseMessage("delete student success"),HttpStatus.OK);
    }
    // search @pathVariable
